...
public:
  ...
  // Accessors
  //
  Intrepid2::Tensor<RealType, FM::FM_3D>&
  getBasis() { return basis; }
...
void parseTensor4(const Teuchos::ParameterList&   pConsts,
                        Intrepid2::Tensor4<RealType, FM::FM_3D>& tensor);
void parseTensor3(const Teuchos::ParameterList&   pConsts,
                        Intrepid2::Tensor3<RealType, FM::FM_3D>& tensor);
void parseTensor (const Teuchos::ParameterList&   pConsts,
                        Intrepid2::Tensor <RealType, FM::FM_3D>& tensor);
